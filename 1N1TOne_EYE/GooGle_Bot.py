...
class Google_search:
    ...
    def __init__(self , Target):
        ...
        self.Target = Target
        self.r = requests.get("https://www.google.com/search?q=%40{}&num=100'".format(Target))
        if "detected unusual traffic" not in self.r.text:
            self.soup = BeautifulSoup(self.r.content , 'html.parser')
            self.result = self.soup.prettify()
        
    def get_emails(self):
        self.rgx = re.compile(r'[a-zA-Z0-9.]+'+'@+'+r'{}'.format(self.Target) , re.VERBOSE)
        self.tmp_email = re.findall(self.rgx ,self.result)
    ...
    def get_pages(self):
        ...
        self.Fac_page = re.findall(self.face_rgx , self.result)
        ...
        self.insta_page = re.findall(self.insta_rgx , self.result)
